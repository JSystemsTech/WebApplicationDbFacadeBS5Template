...
namespace WebApplicationDbFacadeBS5Template.Extensions.Aspose.Cells
{
    public static class WorkbookExtensions
    {
        ...
        {
            if (!workbook.IsLicensed && !string.IsNullOrWhiteSpace(ApplicationConfiguration.AsposeLicensePath))
            {
                AsposeLicense lic = new AsposeLicense();
                lic.SetLicense(ApplicationConfiguration.AsposeLicensePath);
            }
            return workbook;
        }
